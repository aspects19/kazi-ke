              ...
              <View className="mx-10 my-3 w-[80%] bg-white dark:bg-slate-900 border-solid rounded-4xl">
                <View className="rounded-2xl">
                  <Picker
                    ...
                    onValueChange={(item, _index) => setForm({...form, employmentType: item})}>
                    <Picker.Item style={{backgroundColor: '#0f172a', color: '#fff'}} label="full-time" value={"full-time"}/>
                    <Picker.Item style={{backgroundColor: '#0f172a', color: '#fff'}} label="part-time" value={"part-time"}/>
                    <Picker.Item style={{backgroundColor: '#0f172a', color: '#fff'}} label="remote" value={"remote"}/>
                  </Picker>
                </View>
              </View>
